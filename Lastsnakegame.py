...
LB_FLAME_FRAMES = []
for i in range(0, 24):
    p = f"leaderboard_flame_{i:02d}.png"
    try:
...
def _load_flame_frames(prefix, count=24):
    ...
    for i in range(count):
        ...
        try:
            ...
            return []
    return frames
MODE_FLAME_FRAMES = _load_flame_frames("mode_flame_")
GUIDE_FLAME_FRAMES = _load_flame_frames("guide_flame_")
COLOR_FLAME_FRAMES = _load_flame_frames("color_flame_")
...
def draw_mode_screen():
    ...
    draw_button("START", MODE_BTN_START.x, MODE_BTN_START.y, MODE_BTN_START.width, MODE_BTN_START.height, GREEN)
...
def draw_bg_select_screen():
    ...
    draw_button("NEXT", BG_BTN_NEXT.x, BG_BTN_NEXT.y, BG_BTN_NEXT.width, BG_BTN_NEXT.height, GREEN)
# ================= MAIN LOOP =================
